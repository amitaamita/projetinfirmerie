...
<div class="ajouter">
    <?php
echo "<td><a class='ajouter' href=\"rv.php\">prendre un rendez_vous</a></td>";
...
<table>
    ...
    <?php
            ...
            include'./db.php';
                ...
                $affichage = "SELECT * FROM rendez_vouz";
                $resultat = mysqli_query($db,$affichage);
              

            foreach ($resultat as $value) {
                echo "<tr>";
                echo "<td>". $value['nom de famille']. "</td>";
                echo "<td>". $value['sex']. "</td>";
                echo "<td>". $value['adres-mail']. "</td>";
                echo "<td>". $value['date']. "</td>";
                echo "<td>". $value['numero-tel']. "</td>";
               
              
                echo "<td><a class='supprimer' href=\"./delete1.php?id=$value[id]\"
